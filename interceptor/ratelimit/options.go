...
func (l *NoopLimiter) Limit(echo.Context) error {
	return nil
}
...
func (l *ZeroRateLimiter) Limit(echo.Context) error {
...
func (l *tokenBucketLimiter) Limit(ctx echo.Context) error {
	l.delegator.Wait(1)
	return nil
}
...
func (l *leakyBucketLimiter) Limit(ctx echo.Context) error {
	l.delegator.Take()
	return nil
}
