...
func WithTimeoutAndResp(timeout time.Duration, resp echo.HandlerFunc) Option {
...
// If response is nil, default globalResponse will be assigned
func WithTimeoutAndRespByPath(path string, timeout time.Duration, resp echo.HandlerFunc) Option {
	return func(set *optionSet) {
